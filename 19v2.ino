/*
  LiquidCrystal Library - Jumping character
  This is the code for a Jumping costum character
*/
...
void loop() {
  ...
  if (buttonState == HIGH) { // If the user has pushed the button
  ...
  } else { // The user has not pushed the button yet
